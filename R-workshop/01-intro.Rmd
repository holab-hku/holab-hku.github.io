...
read.csv2: variant used in countries that use a comma as decimal point and a semicolon as field separator.
```
...
**Note**
If you don't specify the path, the data will be exported to your working directory.
